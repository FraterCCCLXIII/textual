"""Textual Component Library — a living showcase of every widget and pattern.

Navigate categories with the left sidebar. Each panel demonstrates one
component family with live, interactive examples pulled from across all
other examples in this repo.

Run:
    python examples/component_library.py
"""
...
class ComponentLibraryApp(App):
    ...
    CSS_PATH = "component_library.tcss"

    TITLE = "Textual Component Library"
    SUB_TITLE = "Interactive widget showcase"
